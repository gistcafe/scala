...
object Main extends App {
  ...
  val json = Inspect.readUrlAsText(new URL(s"https://api.github.com/orgs/${orgName}/repos"))
  ...
  val headers = List("name", "language", "watchers", "forks")
  Inspect.printDumpTable(orgRepos.take(10).toList.asJavaCollection, headers.asJavaCollection)
